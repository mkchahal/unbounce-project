    ...
    <section className='banner__wrapper'>
        <div className='banner'>
            <div className='banner__content'>
                ...
                <p>Turn more of your visitors into customers. Unbounce is the AI-powered landing page builder with smart features that let you create beautiful, high-performing marketing campaigns in just a few minutes.</p>
