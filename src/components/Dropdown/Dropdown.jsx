        ...
        <section className='dropdrown'>     
            <div className='dropdrown__container'>
                <div className='dropdrown__description'>
                    <h2 className='dropdrown__title--padding'>New Features</h2>
                ...
                <div className='dropdrown__box--padding'>
                    ...
                    <a href='https://documentation.unbounce.com/hc/en-us/categories/4403206140436?_ga=2.266915022.1947046721.1656022238-170502297.1655768346' target="_blank" rel='noreferrer' className='dropdrown__btn'>Learn More</a>
                </div>
                <div className='dropdrown__box'>
                ...
                <div className='dropdrown__box--padding'>
                    ...
                    <a href='https://documentation.unbounce.com/hc/en-us/categories/4406903492372-Working-with-Smart-Copy-?_ga=2.31573630.1947046721.1656022238-170502297.1655768346' target="_blank" rel='noreferrer'  className='dropdrown__btn'>Learn More</a>
                </div>
                <div className='dropdrown__box'>
                ...
                <div className='dropdrown__box--padding'>
                    <img className='dropdrown__tag' src={New} alt={'beta'}></img>
                    <a href='https://documentation.unbounce.com/hc/en-us/categories/4417905900564-Unbounce-Apps?_ga=2.61048428.1947046721.1656022238-170502297.1655768346' target="_blank" rel='noreferrer' className='dropdrown__btn'>Learn More</a>
                </div>
            </div>
            <div className='dropdrown__container--invisible'>
                ...
                <div className='dropdrown__app-container'>
                    <a href='https://documentation.unbounce.com/hc/en-us/categories/4417905900564-Unbounce-Apps' target="_blank" rel='noreferrer' className='dropdrown__btn--large'>Documentation</a>
